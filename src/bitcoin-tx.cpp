...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bestcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bestcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bestcoin transaction") + "\n" +
              "  bestcoin-tx [options] -create [commands]   " + _("Create hex-encoded bestcoin transaction") + "\n" +
              "\n";
